...
Usage()
{
	...
	echo -e "\tFunction"
	echo -e "\tAnalyze salmon DI miRNA-seq data, including control the quality of raw fastq; trim adapter and control the quality again; align to genome; generate read counts matrix.\n"
